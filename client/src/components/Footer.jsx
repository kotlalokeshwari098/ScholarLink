    ...
    <footer className="bg-gray-800 text-gray-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h2 className="text-white text-2xl font-bold mb-4">ScholarLink</h2>
            <p className="text-gray-400 mb-4">
              Connecting students to global education opportunities through our
              comprehensive scholarship platform.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter for the latest scholarships and tips.
            </p>
            <form className="flex">
              <input
                type="email"
