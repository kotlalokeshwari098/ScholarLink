      ...
      <div className="min-h-screen bg-gray-50 py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center mb-6 animate-pulse">
            <div className="h-3 bg-gray-200 rounded w-10 mr-2"></div>
            <div className="h-3 bg-gray-300 rounded w-2 mx-2"></div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8 animate-pulse">
            ...
            <div className="p-8">
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <div className="h-6 bg-green-100 rounded-full w-32"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 animate-pulse">
                <div className="h-5 bg-blue-200 rounded w-40 mb-2"></div>
                <div className="h-4 bg-blue-200 rounded w-full mb-4"></div>
