...
const Profile = () => {
  ...
  // Check if we're coming from compatibility check
  useEffect(() => {
    if (location.state?.fromCompatibility) {
      setNotification({
        message:
          location.state.message ||
          "Please complete your profile to continue with the compatibility test",
        type: "info",
      });
    }
  }, [location]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.user) {
        ...
        // If we came from compatibility check, redirect back to it
        if (location.state?.fromCompatibility) {
